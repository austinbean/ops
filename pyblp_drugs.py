...
l_bfg = pyblp.Optimization('l-bfgs-b',method_options={'gtol': 1e-6} )
...
sigma_upper = 3*np.eye(3)

with pyblp.parallel(10):
    results1 = mc_problem.solve(sigma=np.eye(3), sigma_bounds=(sigma_lower,sigma_upper), optimization=l_bfg, iteration=iteration_options)
