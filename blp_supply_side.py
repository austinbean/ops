...
agent_formulation = pyblp.Formulation('0 + male + hhinc + unemp + education')        # options: male, race, disability, hhinc, education, labor, unemp
...
initial_pi = np.random.rand(4,4) # length X2 x length agent_formulation
