...
function Instruments()
    ...
    return convert(Array{Float64,2}, inst[!, ["smme_prod_instrument", "sp_prod_instrument", "scov_price_ingredient_instrument", "scov_mme_package_instrument", "scov_price_package_instrument", "scov_price_mme_instrument", "ssub_instrument", "spackage_instrument", "smme_instrument", "sp_instrument"]])  
end 
